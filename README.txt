...
The SIF3 Training is a Java project designed for SIF3 Training courses (US Data Model).
...
==============================
From the command-line type: git clone git://github.com/nsip/sif3-training-US-java.git
