package api.mapping.sif32Simple;
import java.util.ArrayList;

//import api.dataModel.sif32Simple.*;
...
//public K12StudentCore modelToSIF32Simple(R1Student r1Student)
//{
//	K12StudentCore sifStudent = new K12StudentCore();
//	Demographics sifDemographics = new Demographics();
//	ArrayList<Race> sifRaces = new ArrayList<Race>();
//	ArrayList<Language> sifLanguages = new ArrayList<Language>();
//	
//	
//	
//	/********** Name **********/
...
//	
//	/********** Demographics **********/
//	sifDemographics.setSex(r1Student.getSexCode());
//	sifDemographics.setUsCitizenShipStatus(r1Student.getUsCitizenshipStatusCode());
//	
//
//	//Race
//	for(R1StudentRace race : r1Student.getR1StudentRaces())
//	{
//		Race sifRace = new Race();
//		sifRace.setRace(race.getRaceCode());
//		sifRaces.add(sifRace);
//	}
//	sifDemographics.setRaces(sifRaces);
//	
//	/********** Languages **********/
//	for(R1StudentLanguage language : r1Student.getR1StudentLanguages())
//	{
//		Language sifLanguage = new Language();				
//		sifLanguage.setCode(language.getLanguageCode());
//		sifLanguage.setType(language.getLanguageUseTypeCode());
//		sifLanguages.add(sifLanguage);		
//	}
//	
//	
//	sifStudent.setRefId(r1Student.getStudentRefId());
//	sifStudent.setName(sifName);
//	sifStudent.setLanguages(sifLanguages);
//	sifStudent.setDemographics(sifDemographics);
//	
//	return sifStudent;
//}
//
